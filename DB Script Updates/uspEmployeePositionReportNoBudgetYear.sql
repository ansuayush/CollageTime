...
Alter procedure [dbo].[uspEmployeePositionReportNoBudgetYear]  
as   
/*  
 Changes  
...
select   
 ...
 E_Positions.actualEndDate as EndDate,   
...
from   
 ...
 left join dbo.E_Positions on E_Positions.employeeID = employees.EmployeeId    
 ...
 inner join CompanyCodes cc on cc.CompanyCodeId=employees.CompanyCodeId  
 ...
 left join dbo.DdlPayFrequencies on DdlPayFrequencies.PayFrequencyId = E_Positions.PayFrequencyId